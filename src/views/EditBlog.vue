  ...
  <div class="create-post">
    ...
    <div class="container">
      <div :class="{ invisible: !error }" class="err-message">
        <p><span>错误：</span>{{ this.errorMsg }}</p>
      </div>
      <div class="blog-info">
        <input type="text" placeholder="输入文章题目" v-model="blogTitle" />
...
export default {
  ...
  async mounted() {
    this.routeID = await this.$route.params.blogid;
